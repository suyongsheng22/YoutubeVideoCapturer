...
import '../Pages/styling/error.css';
export default class errorpage404 extends Component {
   ...
   componentDidMount() {
      document.title = 'Page Not Found - Welcome to Sunrise';
   }
      ...
      return (
         <div className="main">
            ...
            <div className="error_message_container">
               ...
               <a href="/Gallery" className="error-button">
                  Return To Homepage
               </a>

               <p className="error-text2">
                  Auto Redirect In {this.state.countdown}s
               </p>
            </div>
         </div>
      );
